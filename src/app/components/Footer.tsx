...
const Footer = () => (
  <footer className="flex flex-col items-center gap-6 bg-primary py-8 text-sm text-white md:flex-row md:justify-between lg:px-32">
    <div className="md:flex md:flex-row md:gap-14 md:pl-10">
      <div>
      ...
      <div className="flex flex-col gap-3 pt-4 text-center text-secondary md:pt-0 md:text-left">
        <div>
      ...
      <div className="flex flex-col gap-3 pt-3 text-center text-secondary md:pt-0 md:text-left">
        <div>
    ...
    <div className="flex flex-col items-center gap-3 md:items-end md:pr-10 md:text-right">
      <div className="md:pb-8">
        <button className="rounded-3xl bg-gradient-to-r from-lime-green to-bright-cyan px-6 py-2 text-white duration-300 hover:opacity-60" type="button">
          Request Invite
        </button>
      </div>
